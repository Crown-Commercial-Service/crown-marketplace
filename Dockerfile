...
ARG APP_RUN_SUPPLIER_KEY_CONVERSION
LABEL app_run_supplier_key_conversion=$APP_RUN_SUPPLIER_KEY_CONVERSION
ENV APP_RUN_SUPPLIER_KEY_CONVERSION=$APP_RUN_SUPPLIER_KEY_CONVERSION
