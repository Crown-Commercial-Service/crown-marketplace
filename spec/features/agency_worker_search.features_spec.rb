...
RSpec.feature 'Agency workers', type: :feature do
  ...
  def a_managed_service_provider
    I18n.t('search.looking_for.answer_managed_service_provider')
  end
  ...
  def an_individual_worker
    I18n.t('search.looking_for.answer_worker')
  end
  ...
  def yes
    I18n.t('search.worker_type.answer_agency_supplied')
  end
  ...
  def no
    I18n.t('search.worker_type.answer_nominated_worker')
  end
end
