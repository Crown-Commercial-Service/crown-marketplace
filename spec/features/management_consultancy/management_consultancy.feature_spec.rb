...
RSpec.feature 'Management consultancy', type: :feature do
  ...
  scenario 'Buyer wants to buy business consultancy services (MCF2 Lot 1) and pays expenses' do
  ...
  scenario 'Buyer wants to buy business consultancy services (MCF2 Lot 1) and does not pay expenses' do
    visit_management_consultancy_start
