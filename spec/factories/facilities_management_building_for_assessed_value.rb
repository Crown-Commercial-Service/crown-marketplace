FactoryBot.define do
  factory :facilities_management_procurement_building_av_default, class: 'FacilitiesManagement::ProcurementBuilding' do
    active { true }
    building { create :facilities_management_building }
  end

  factory :facilities_management_procurement_building_av_normal_building, parent: :facilities_management_procurement_building_av_default do
  ...
  factory :facilities_management_procurement_building_av_london_building, parent: :facilities_management_procurement_building_av_default do
