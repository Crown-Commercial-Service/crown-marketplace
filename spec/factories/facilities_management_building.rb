FactoryBot.define do
  factory :facilities_management_building_ar_defaults1, class: FacilitiesManagement::Building do
    id { SecureRandom.uuid }
    updated_by { Faker::Internet.unique.email }
    association :user
  end

  factory :facilities_management_building_ar, parent: :facilities_management_building_ar_defaults1 do
    gia { 1002 }
