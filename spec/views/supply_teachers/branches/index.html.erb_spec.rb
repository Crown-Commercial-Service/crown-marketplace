...
RSpec.describe 'supply_teachers/branches/index.html.erb' do
  ...
  it 'displays the buyers selection' do
    expect(rendered).to have_css('.govuk-list li', text: /Looking for\: Individual worker/)
    expect(rendered).to have_css('.govuk-list li', text: /Worker type\: Nominated/)
    expect(rendered).to have_css('.govuk-list li', text: /Postcode\: SW1A 1AA/)
  end
