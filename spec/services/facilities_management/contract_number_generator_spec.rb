...
RSpec.describe FacilitiesManagement::ContractNumberGenerator do
  ...
  describe '.used_contract_numbers_for_current_year' do
    ...
    context 'when the framework is RM6232' do
      ...
      before do
        create(:facilities_management_rm6232_procurement_no_procurement_buildings, :skip_before_create, contract_number: "RM6232-000005-#{current_year}")
        create(:facilities_management_rm6232_procurement_no_procurement_buildings, :skip_before_create, contract_number: "RM6232-000006-#{current_year}")
        create(:facilities_management_rm6232_procurement_no_procurement_buildings, :skip_before_create, contract_number: 'RM6232-000007-2019')
        create(:facilities_management_rm6232_procurement_no_procurement_buildings, :skip_before_create, contract_number: 'RM6232-000008-2019')
      end
