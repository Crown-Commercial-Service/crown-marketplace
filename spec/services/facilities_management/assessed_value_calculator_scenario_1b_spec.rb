...
RSpec.describe FacilitiesManagement::AssessedValueCalculator do
  ...
  let(:procurement) { create(:facilities_management_procurement_no_procurement_buildings, user: user, estimated_annual_cost: estimated_annual_cost, service_codes: service_codes, **additional_params) }
