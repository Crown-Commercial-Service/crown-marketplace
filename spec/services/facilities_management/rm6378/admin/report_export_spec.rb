...
RSpec.describe FacilitiesManagement::RM6378::Admin::ReportExport do
  ...
  let(:procurement_1) { create(:facilities_management_rm6378_procurement, user: user_1, framework: framework, lot_id: 'RM6378.1a', created_at: 6.days.ago, procurement_details: { 'service_ids' => ['RM6378.1a.E1', 'RM6378.1a.E2'], 'jurisdiction_ids' => ['TLH3', 'TLH5'], 'annual_contract_value' => 12_345, 'contract_start_date_dd' => '1', 'contract_start_date_mm' => '1', 'contract_start_date_yyyy' => '2028', 'estimated_contract_duration' => 10, 'private_finance_initiative' => 'yes', 'contact_opt_in' => true }) }
  let(:procurement_2) { create(:facilities_management_rm6378_procurement, user: user_2, framework: framework, lot_id: 'RM6378.2a', created_at: 5.days.ago, procurement_details: { 'service_ids' => ['RM6378.2a.C13', 'RM6378.2a.C6'], 'jurisdiction_ids' => ['TLH6', 'TLL31'], 'annual_contract_value' => 28_363, 'contract_start_date_dd' => '6', 'contract_start_date_mm' => '3', 'contract_start_date_yyyy' => '2029', 'estimated_contract_duration' => 85, 'private_finance_initiative' => 'no', 'contact_opt_in' => false }) }
  let(:procurement_3) { create(:facilities_management_rm6378_procurement, user: user_3, framework: framework, lot_id: 'RM6378.3a', created_at: 4.days.ago, procurement_details: { 'service_ids' => ['RM6378.3a.J3', 'RM6378.3a.O8'], 'jurisdiction_ids' => ['TLI6', 'TLL34'], 'annual_contract_value' => 93_874, 'contract_start_date_dd' => '18', 'contract_start_date_mm' => '7', 'contract_start_date_yyyy' => '2028', 'estimated_contract_duration' => 53, 'private_finance_initiative' => 'no', 'contact_opt_in' => false }) }
  let(:procurement_4) { create(:facilities_management_rm6378_procurement, user: user_1, framework: framework, lot_id: 'RM6378.4a', created_at: 3.days.ago, procurement_details: { 'service_ids' => ['RM6378.4a.R1', 'RM6378.4a.U1'], 'jurisdiction_ids' => ['TLH4', 'TLN07'], 'annual_contract_value' => 61_062, 'contract_start_date_dd' => '25', 'contract_start_date_mm' => '11', 'contract_start_date_yyyy' => '2034', 'estimated_contract_duration' => 88, 'private_finance_initiative' => 'yes', 'contact_opt_in' => false }) }
  let(:procurement_5) { create(:facilities_management_rm6378_procurement, user: user_2, framework: framework, lot_id: 'RM6378.4b', created_at: 2.days.ago, procurement_details: { 'service_ids' => ['RM6378.4b.O4', 'RM6378.4b.O7'], 'jurisdiction_ids' => ['TLC3', 'TLL51'], 'annual_contract_value' => 19_176, 'contract_start_date_dd' => '19', 'contract_start_date_mm' => '8', 'contract_start_date_yyyy' => '2035', 'estimated_contract_duration' => 15, 'private_finance_initiative' => 'no', 'contact_opt_in' => true }) }
  let(:procurement_6) { create(:facilities_management_rm6378_procurement, user: user_3, framework: framework, lot_id: 'RM6378.4c', created_at: 1.day.ago, procurement_details: { 'service_ids' => ['RM6378.4c.P1', 'RM6378.4c.Q2'], 'jurisdiction_ids' => ['TLE3', 'TLM03'], 'annual_contract_value' => 58_348, 'contract_start_date_dd' => '14', 'contract_start_date_mm' => '6', 'contract_start_date_yyyy' => '2037', 'estimated_contract_duration' => 42, 'private_finance_initiative' => 'yes', 'contact_opt_in' => false }) }
  let(:procurement_7) { create(:facilities_management_rm6378_procurement, user: user_1, framework: framework, lot_id: 'RM6378.4d', created_at: Time.now.in_time_zone('London'), procurement_details: { 'service_ids' => ['RM6378.4d.T1', 'RM6378.4d.T2'], 'jurisdiction_ids' => ['TLJ2', 'TLN09'], 'annual_contract_value' => 89_858, 'contract_start_date_dd' => '12', 'contract_start_date_mm' => '7', 'contract_start_date_yyyy' => '2036', 'estimated_contract_duration' => 96, 'private_finance_initiative' => 'no', 'contact_opt_in' => false }) }
  let(:procurement_8) { create(:facilities_management_rm6378_procurement, user: user_1, framework: other_framework, lot_id: 'RM6378.1b', created_at: 3.days.ago, procurement_details: { 'service_ids' => ['RM6378.1b.C8', 'RM6378.1b.D12'], 'jurisdiction_ids' => ['TLF1', 'TLN0B'], 'annual_contract_value' => 68_554, 'contract_start_date_dd' => '16', 'contract_start_date_mm' => '1', 'contract_start_date_yyyy' => '2030', 'estimated_contract_duration' => 69, 'private_finance_initiative' => 'no', 'contact_opt_in' => true }) }
