    ...
    context 'when supplier does not exist' do
      ...
      context 'and supplier is offering lot 1 services' do
          ...
          [
            {
              ...
              supplier_framework_lot_services: [
                {
                  service_id: 'RM6360.4a.1'
                },
                {
                  service_id: 'RM6360.4a.2'
                }
              ],
        ...
        it 'assigns attributes to the framework lot' do
          ...
          expect(supplier_framework.lots.pluck(:lot_id)).to eq(['RM6360.4a', 'RM6360.4b'])
        end

        it 'assigns attributes to the framework lot services' do
          result

          expect(supplier_framework.lots.map { |lot| lot.services.pluck(:service_id) }).to eq([['RM6360.4a.1', 'RM6360.4a.2'], ['RM6360.4b.1']])
        end
      end
      ...
      context 'and supplier has rates' do
          ...
          [
            {
              ...
              supplier_framework_lot_jurisdictions: [
                {
                  jurisdiction_id: 'RM6360.GB'
                },
                {
                  jurisdiction_id: 'RM6360.DE'
                }
              ],
              supplier_framework_lot_rates: [
                {
        ...
        it 'assigns attributes to the jurisdictions' do
          ...
          expect(supplier_framework.lots.map { |lot| lot.jurisdictions.pluck(:jurisdiction_id) }).to eq([['RM6360.GB', 'RM6360.DE'], ['RM6360.GB']])
        end
