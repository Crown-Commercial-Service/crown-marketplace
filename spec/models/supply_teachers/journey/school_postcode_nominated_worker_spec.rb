...
RSpec.describe SupplyTeachers::Journey::SchoolPostcodeNominatedWorker, type: :model do
  subject(:step) { described_class.new(postcode: postcode) }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/journey/school_postcode_nominated_worker' }
