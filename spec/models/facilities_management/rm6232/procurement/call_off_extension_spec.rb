...
RSpec.describe FacilitiesManagement::RM6232::Procurement::CallOffExtension, type: :model do
  subject(:call_off_extension) { create(:facilities_management_rm6232_procurement_call_off_extension) }
