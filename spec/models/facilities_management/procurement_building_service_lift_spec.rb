...
RSpec.describe FacilitiesManagement::ProcurementBuildingServiceLift, type: :model do
  describe '#valid?' do
    let(:lift) { create(:facilities_management_lift, procurement_building_service: procurement_building_service) }
    let(:procurement_building_service) { create(:facilities_management_procurement_building_service, procurement_building: procurement_building) }
