...
RSpec.describe FacilitiesManagement::RM3830::Procurement do
  ...
  describe '#set_state_to_results_if_possible' do
    ...
    before do
      ...
      allow(obj).to receive_messages(assessed_value: 0.1234, lot_number: '1a', sorted_list: [{ supplier_name: 'test', supplier_id: supplier_ids[0], da_value: da_value_test }, { supplier_name: 'test1', supplier_id: supplier_ids[1], da_value: da_value_test1 }])
    end
