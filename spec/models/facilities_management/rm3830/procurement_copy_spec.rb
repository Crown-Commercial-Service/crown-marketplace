  ...
  describe '#create_procurement_copy' do
    ...
    context 'when a copy has been made of a procurement with full use of contact details' do
      context 'when comparing attributes' do
        it 'does not have a contract name' do
          expect(procurement_copy.contract_name).to be_nil
        end

        it 'has an aasm_state of details_search' do
          expect(procurement_copy.aasm_state).to eq 'detailed_search'
        end

        it 'has a da_journey_state of pricing' do
          expect(procurement_copy.da_journey_state).to eq 'pricing'
        end

        it 'has the same attributes as the procurement' do
      ...
      context 'when considering optional call of extensions' do
        it 'has the extension periods' do
          expect(procurement_copy.call_off_extensions.size).to eq 4
        end

        it 'has the right period for extension 1' do
        ...
        it 'has the right period for extension 2' do
        ...
        it 'has the right period for extension 3' do
        ...
        it 'has the right period for extension 4' do
      ...
      context 'when considering procurement buildings' do
        it 'has procurement buildings' do
          expect(procurement_copy.procurement_buildings).not_to be_empty
        end

        it 'has the same procurement buildings' do
      ...
      context 'when considering pension funds' do
        it 'has procurement pension funds' do
          expect(procurement_copy.procurement_pension_funds).not_to be_empty
        end

        it 'has the same pension fund attributes as the origional procurement' do
      ...
      context 'when considering contact details' do
        ...
        it 'has the same invoice contact detail' do
        ...
        it 'has the same authorised contact detail' do
        ...
        it 'has the same notices contact detail' do
      ...
      it 'does not have procurement suppliers' do
    ...
    context 'when a copy has been made of a procurement without full use of contact details' do
      ...
      it 'does not have contact details' do
      ...
      it 'does not have pension funds' do
        expect(second_procurement_copy.procurement_pension_funds).to be_empty
      end

      it 'has not have a security policy document file' do
