      ...
      context "when the framework is #{framework}" do
        context 'when user is buyer without buyer details' do
          it 'returns true' do
            ...
            expect(user.fm_buyer_details_incomplete?(framework)).to be true
          end
        end
        ...
        context 'when user isn\'t a buyer' do
          it 'returns false' do
            ...
            expect(user.fm_buyer_details_incomplete?(framework)).to be false
          end
        end
        ...
        context 'when user is a buyer and has complete details' do
          ...
          context 'when excluding contact_opt_in' do
            before { user.buyer_detail.contact_opt_in = nil }

            it "returns #{expected_result}" do
              expect(user.fm_buyer_details_incomplete?(framework)).to be expected_result
            end
          end
        end
      end
