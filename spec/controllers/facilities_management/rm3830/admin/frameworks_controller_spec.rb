...
RSpec.describe FacilitiesManagement::RM3830::Admin::FrameworksController do
  let(:default_params) { { service: 'facilities_management/admin', framework: 'RM3830' } }
  let(:framework) { Framework.find('RM3830') }
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to facilities_management_rm3830_admin_frameworks_path' do
        expect(response).to redirect_to facilities_management_rm3830_admin_frameworks_path
      end
    end
