...
RSpec.describe FacilitiesManagement::RM3830::Procurements::Contracts::ClosedController do
  ...
  describe 'GET index' do
    context 'when user enter a url for a contract that the user has closed' do
