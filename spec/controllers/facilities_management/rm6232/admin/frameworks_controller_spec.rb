...
RSpec.describe FacilitiesManagement::RM6232::Admin::FrameworksController do
  let(:default_params) { { service: 'facilities_management/admin', framework: 'RM6232' } }
  let(:framework) { Framework.find('RM6232') }
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to facilities_management_rm6232_admin_frameworks_path' do
        expect(response).to redirect_to facilities_management_rm6232_admin_frameworks_path
      end
    end
