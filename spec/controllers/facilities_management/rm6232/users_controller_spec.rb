...
RSpec.describe FacilitiesManagement::RM6232::UsersController, type: :controller do
    ...
    context 'when the framework is live' do
      ...
      context 'when the challenge is NEW_PASSWORD_REQUIRED' do
        ...
        it 'renders the new_password_required partial' do
          expect(response).to render_template('facilities_management/rm6232/users/_new_password_required')
        end
      end
      ...
      context 'when the challenge is SMS_MFA' do
        ...
        it 'renders the sms_mfa partial' do
          expect(response).to render_template('facilities_management/rm6232/users/_sms_mfa')
        end
      end
    end
