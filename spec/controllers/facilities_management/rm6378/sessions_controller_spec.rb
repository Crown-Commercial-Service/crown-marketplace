...
RSpec.describe FacilitiesManagement::RM6378::SessionsController do
  ...
  describe 'POST create' do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the password needs to be reset' do
        ...
        it 'redirects to facilities_management_rm6378_edit_user_password_path' do
          expect(response).to redirect_to facilities_management_rm6378_edit_user_password_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is no challenge' do
        ...
        it 'redirects to facilities_management_rm6378_path' do
          expect(response).to redirect_to facilities_management_rm6378_path
        end
      end
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to facilities_management_rm6378_users_challenge_path' do
          expect(response).to redirect_to facilities_management_rm6378_users_challenge_path(challenge_name:)
        end
