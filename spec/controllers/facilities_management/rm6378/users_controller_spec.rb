...
RSpec.describe FacilitiesManagement::RM6378::UsersController do
        ...
        context 'and it is valid' do
          context 'and there is an additional challange' do
            ...
            it 'redirects to facilities_management_rm6378_users_challenge_path' do
              expect(response).to redirect_to facilities_management_rm6378_users_challenge_path(challenge_name: new_challenge_name)
            end
