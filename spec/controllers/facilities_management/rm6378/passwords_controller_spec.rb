...
RSpec.describe FacilitiesManagement::RM6378::PasswordsController do
  ...
  describe 'PUT update' do
    context 'when the framework is live' do
      ...
      context 'when the reset password is valid' do
        ...
        it 'redirects to facilities_management_rm6378_password_reset_success_path' do
          expect(response).to redirect_to facilities_management_rm6378_password_reset_success_path
        end
