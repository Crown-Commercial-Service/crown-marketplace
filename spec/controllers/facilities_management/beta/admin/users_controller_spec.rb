...
RSpec.describe FacilitiesManagement::Beta::Admin::UsersController do
  ...
  describe 'After sign-in' do
    ...
    context 'when confirm user' do
      it 'redirects to the /facilities-management/beta/admin/users/confirm_new page' do
        expect(controller.confirm_user_registration_path).to eq facilities_management_beta_admin_users_confirm_path(email: user.email)
      end
    end
  end
end
