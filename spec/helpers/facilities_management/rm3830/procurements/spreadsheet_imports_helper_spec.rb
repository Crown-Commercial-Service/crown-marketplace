...
RSpec.describe FacilitiesManagement::RM3830::Procurements::SpreadsheetImportsHelper, type: :helper do
  ...
  describe '.error_count' do
    ...
    let(:spreadsheet_import) { create(:facilities_management_procurement_spreadsheet_import, import_errors: import_errors, procurement: create(:facilities_management_rm3830_procurement, aasm_state: 'detailed_search_bulk_upload', user: create(:user))) }
