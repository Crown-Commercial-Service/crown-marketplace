...
RSpec.describe FacilitiesManagement::Beta::Supplier::SupplierRatesHelper, type: :helper do
  describe 'Supplier rates helper tests' do
    context 'with rates in work_packages as sub array' do
      it 'Will return a rates array' do
        ...
        work_packages_with_rates = FacilitiesManagement::Beta::Supplier::SupplierRatesHelper.add_rates_to_work_packages(work_packages, rates_list)
