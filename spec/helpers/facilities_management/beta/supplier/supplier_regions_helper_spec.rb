...
RSpec.describe FacilitiesManagement::Beta::Supplier::SupplierRegionsHelper, type: :helper do
  describe 'Supplier regions helper' do
    context 'when selected regions for lot 1a' do
      it 'will return region code with true' do
        ...
        selected_regions = FacilitiesManagement::Beta::Supplier::SupplierRegionsHelper.supllier_selected_regions_1a(supllier)
