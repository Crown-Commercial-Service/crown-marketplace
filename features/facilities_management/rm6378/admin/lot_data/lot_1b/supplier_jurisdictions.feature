Feature: Facilities Management - Admin - Supplier lot data - 1b - View jurisdictions
  ...
  Scenario: Services
    ...
    And I click on 'View jurisdictions' for the lot 'Lot 1b - Total Facilities Management'
