Feature: Facilities Management - Admin - Supplier lot data - 4c - View jurisdictions
  ...
  Scenario: Services
    ...
    And I click on 'View jurisdictions' for the lot 'Lot 4c - Electronic security systems and services'
