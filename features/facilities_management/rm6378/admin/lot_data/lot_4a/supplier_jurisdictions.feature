Feature: Facilities Management - Admin - Supplier lot data - 4a - View jurisdictions
  ...
  Scenario: Services
    ...
    And I click on 'View jurisdictions' for the lot 'Lot 4a - Total Security Services'
