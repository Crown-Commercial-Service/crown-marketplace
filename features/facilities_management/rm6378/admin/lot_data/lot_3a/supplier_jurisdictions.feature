Feature: Facilities Management - Admin - Supplier lot data - 3a - View jurisdictions
  ...
  Scenario: Services
    ...
    And I click on 'View jurisdictions' for the lot 'Lot 3a - Soft Facilities Management'
