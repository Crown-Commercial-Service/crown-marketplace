Feature: Facilities Management - Admin - Supplier lot data - 2a - View jurisdictions
  ...
  Scenario: Services
    ...
    And I click on 'View jurisdictions' for the lot 'Lot 2a - Hard Facilities Management'
