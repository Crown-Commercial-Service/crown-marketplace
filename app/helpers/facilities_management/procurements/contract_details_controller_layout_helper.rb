...
module FacilitiesManagement::Procurements::ContractDetailsControllerLayoutHelper
  ...
  def page_definitions
    @page_definitions ||= {
      ...
      payment_method: {
        back_url: facilities_management_procurement_contract_details_path,
        continuation_text: 'Save and return',
        return_text: 'Return to contract details',
        return_url: facilities_management_procurement_contract_details_path,
      ...
      new_invoicing_contact_details: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'invoicing_contact_details'),
        back_text: 'Return to invoicing contact details',
        continuation_text: 'Save and return',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'invoicing_contact_details'),
        return_text: 'Return to invoicing contact details',
      },
      new_invoicing_contact_details_address: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'new_invoicing_contact_details'),
        back_text: 'Return to new invoicing contact details',
        page_title: 'Add address',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'new_invoicing_contact_details'),
      ...
      new_authorised_representative: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'authorised_representative'),
        back_text: 'Return to authorised representative details',
        continuation_text: 'Save and return',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'authorised_representative'),
        return_text: 'Return to authorised representative details',
      },
      new_authorised_representative_address: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'new_authorised_representative'),
        back_text: 'Return to new authorised representative details',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'new_authorised_representative'),
      ...
      new_notices_contact_details: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'notices_contact_details'),
        back_text: 'Return to notices contact details',
        continuation_text: 'Save and return',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'notices_contact_details'),
        return_text: 'Return to notices contact details',
      },
      new_notices_contact_details_address: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'new_notices_contact_details'),
        back_text: 'Return to new notices contact details',
        return_url: facilities_management_procurement_contract_details_edit_path(page: 'new_notices_contact_details'),
      ...
      pension_funds: {
        back_url: facilities_management_procurement_contract_details_edit_path(page: 'local_government_pension_scheme'),
