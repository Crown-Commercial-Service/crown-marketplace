module FacilitiesManagement::Beta::Supplier::ContractsHelper
  ...
  def page_definitions
    @page_definitions ||= {
      ...
      show: {
        back_url: facilities_management_beta_supplier_dashboard_index_path,
        back_label: 'Back',
        back_text: 'Back',
        ...
        secondary_url: facilities_management_beta_supplier_dashboard_index_path,
        return_text: 'Return to dashboard',
        return_url: facilities_management_beta_supplier_dashboard_index_path
      },
      edit: {
