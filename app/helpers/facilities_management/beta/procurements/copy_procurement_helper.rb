module FacilitiesManagement::Beta::Procurements::CopyProcurementHelper
  ...
  def page_back_url
    @contract.nil? ? facilities_management_beta_procurement_path(id: @procurement.id) : facilities_management_beta_procurement_contract_path(procurement_id: @procurement.id, id: find_contract_id)
  end
end
