    ...
    class UploadsController < FrameworkController
      ...
      def create
        ...
        if @upload.save
          ...
          redirect_to legal_services_admin_in_progress_path
        else
      ...
      def approve
        ...
        redirect_to legal_services_admin_upload_uploading_path(upload_id: upload.id)
      end
