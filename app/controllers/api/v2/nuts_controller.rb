...
module Api
  module V2
    ...
    class NutsController < FacilitiesManagement::FrameworkController
      ...
      before_action :validate_service, :redirect_if_unrecognised_framework, except: %i[show_post_code show_nuts_code find_region_query find_region_query_by_postcode]
