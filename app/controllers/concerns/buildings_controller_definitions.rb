  ...
  def page_definitions
    @page_definitions ||= {
      ...
      edit: {
        ...
        page_title: I18n.t('facilities_management.buildings.page_definitions.change_building_details'),
        continuation_text: I18n.t('facilities_management.buildings.page_definitions.save_and_continue'),
        secondary_name: 'save_and_return',
        secondary_text: I18n.t('facilities_management.buildings.page_definitions.save_and_return_to_detailed_summary'),
        back_url: (facilities_management_building_path(@page_data[:model_object].id) if id_present?),
      },
      show: {
      ...
      gia: {
        ...
        page_title: I18n.t('facilities_management.buildings.page_definitions.building_size'),
        continuation_text: I18n.t('facilities_management.buildings.page_definitions.save_and_continue'),
        secondary_name: 'save_and_return',
        secondary_text: I18n.t('facilities_management.buildings.page_definitions.save_and_return_to_detailed_summary'),
        return_url: (type_facilities_management_building_path(@page_data[:model_object].id) if id_present?),
        return_text: I18n.t('facilities_management.buildings.page_definitions.skip_this_step'),
        back_url: (edit_facilities_management_building_path(@page_data[:model_object].id) if id_present?),
      },
      type: {
        caption1: I18n.t('facilities_management.buildings.page_definitions.manage_building_title'),
        caption2: (@page_data[:model_object]&.building_name if @page_data[:model_object].respond_to? :building_name),
        caption3: step_title('type'),
        page_title: I18n.t('facilities_management.buildings.page_definitions.building_type'),
        continuation_text: I18n.t('facilities_management.buildings.page_definitions.save_and_continue'),
        secondary_name: 'save_and_return',
        secondary_text: I18n.t('facilities_management.buildings.page_definitions.save_and_return_to_detailed_summary'),
        return_url: (security_facilities_management_building_path(@page_data[:model_object].id) if id_present?),
        return_text: I18n.t('facilities_management.buildings.page_definitions.skip_this_step'),
        back_url: (gia_facilities_management_building_path(@page_data[:model_object].id) if id_present?),
      },
      security: {
        caption1: I18n.t('facilities_management.buildings.page_definitions.manage_building_title'),
        caption2: (@page_data[:model_object]&.building_name if @page_data[:model_object].respond_to? :building_name),
        caption3: step_title('security'),
        page_title: I18n.t('facilities_management.buildings.page_definitions.security_clearance'),
        continuation_text: I18n.t('facilities_management.buildings.page_definitions.save_and_return_to_detailed_summary'),
        continuation_name: 'save_and_return',
        secondary_name: 'save_and_return',
        secondary_text: I18n.t('facilities_management.buildings.page_definitions.save_and_return_to_detailed_summary'),
        return_url: (facilities_management_building_path(@page_data[:model_object].id) if id_present?),
        return_text: I18n.t('facilities_management.buildings.page_definitions.skip_this_step'),
        back_url: (type_facilities_management_building_path(@page_data[:model_object].id) if id_present?)
      }
    }.freeze
  end
