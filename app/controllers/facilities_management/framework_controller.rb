module FacilitiesManagement
  class FrameworkController < ::ApplicationController
    ...
    def path_an_exception?
      ...
      %w[users sign-in sign-out resend_confirmation_email sign-up domain-not-on-safelist buyer-details api not-permitted].any? { |path_section| full_path.include?(path_section) }
    end
  end
end
