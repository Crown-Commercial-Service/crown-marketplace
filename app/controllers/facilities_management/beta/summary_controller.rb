  ...
  module Beta
    class SummaryController < FacilitiesManagement::Beta::FrameworkController
      ...
      def sorted_suppliers
        ...
        spreadsheet1 = FacilitiesManagement::DirectAwardSpreadsheet.new @supplier_name, @report_results[@supplier_name], @report_results_no_cafmhelp_removed[@supplier_name], uvals
      ...
      def build_direct_award_report(cache__calculation_values_for_spreadsheet_flag)
        ...
        supplier_names.each do |supplier_name|
          ...
          @report.calculate_services_for_buildings @selected_buildings, uvals, supplier_name, a_supplier_calculation_results, true, :da
          ...
          @report.calculate_services_for_buildings @selected_buildings, uvals, supplier_name, a_supplier_calculation_results_no_cafmhelp_removed, false, :da
        end
