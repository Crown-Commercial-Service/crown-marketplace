module FacilitiesManagement
  module RM3830
    class ProcurementsController < FacilitiesManagement::FrameworkController
      ...
      def index
        @searches = current_user.rm3830_procurements.searches
        @in_draft = current_user.rm3830_procurements.in_draft
        @sent_offers = current_user.rm3830_procurements.sent_offers
        @contracts = current_user.rm3830_procurements.live_contracts
        @closed_contracts = current_user.rm3830_procurements.closed_contracts
        @further_competition_contracts = current_user.rm3830_procurements.further_competition_contracts
      end
