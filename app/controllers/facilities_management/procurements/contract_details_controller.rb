  ...
  module Procurements
    class ContractDetailsController < FacilitiesManagement::FrameworkController
      ...
      def redirect_if_not_in_contract_details
        redirect_to facilities_management_procurement_contract_details_path unless @procurement.contract_details?
      end
      ...
      def route_local_government_pension_scheme
        @procurement.local_government_pension_scheme ? redirect_to(facilities_management_procurement_contract_details_edit_path(page: 'pension_funds')) : redirect_to(facilities_management_procurement_contract_details_path)
      end

      def route_new_contact_detail
        if !using_buyer_detail_for_contact? && !contact_detail_exists?
          redirect_to(facilities_management_procurement_contract_details_edit_path(page: "new_#{@page_name}"))
        else
          redirect_to(facilities_management_procurement_contract_details_path)
        end
      end
