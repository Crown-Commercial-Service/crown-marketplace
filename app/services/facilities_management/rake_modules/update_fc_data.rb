module FacilitiesManagement::RakeModules::UpdateFCData
  def self.update_fc_data
    FacilitiesManagement::RM3830::Procurement.further_competition.where(contract_number: nil).find_in_batches do |group|
  ...
  def self.used_numbers(year)
    FacilitiesManagement::RM3830::Procurement.where('contract_number like ?', 'RM3860-FC%')
