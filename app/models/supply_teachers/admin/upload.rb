module SupplyTeachers
  module Admin
    class Upload < ApplicationRecord
      ...
      CURRENT_ACCREDITED_PATH = Rails.root.join('lib', 'tasks', 'supply_teachers', 'input', 'current_accredited_suppliers.xlsx').freeze
      GEOGRAPHICAL_DATA_PATH = Rails.root.join('lib', 'tasks', 'supply_teachers', 'input', 'geographical_data_all_suppliers.xlsx').freeze
      ...
      PRICING_TOOL_PATH = Rails.root.join('lib', 'tasks', 'supply_teachers', 'input', 'pricing_for_tool.xlsx').freeze
