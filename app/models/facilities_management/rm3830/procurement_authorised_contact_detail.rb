module FacilitiesManagement
  module RM3830
    class ProcurementAuthorisedContactDetail < ProcurementContactDetail
      belongs_to :procurement, class_name: 'FacilitiesManagement::RM3830::Procurement', foreign_key: :facilities_management_procurement_id, inverse_of: :authorised_contact_detail
