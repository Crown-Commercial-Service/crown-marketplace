  ...
  module RM6378
    module Admin
      class SupplierData < ApplicationRecord
        belongs_to :upload, inverse_of: :supplier_data, foreign_key: :facilities_management_rm6378_admin_upload_id, optional: true
        has_many :edits, inverse_of: :supplier_data, class_name: 'FacilitiesManagement::RM6378::Admin::SupplierData::Edit', dependent: :destroy, foreign_key: :facilities_management_rm6378_admin_supplier_data_id
