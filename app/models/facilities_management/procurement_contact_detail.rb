module FacilitiesManagement
  class ProcurementContactDetail < ApplicationRecord
    ...
    def valid_postcode?
      organisation_address_line_1&.present? && organisation_address_town&.present?
    end

    private

    def address_present?
      return true if organisation_address_line_1&.present? && organisation_address_town&.present? && organisation_address_postcode&.present?
