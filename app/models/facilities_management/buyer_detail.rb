module FacilitiesManagement
  class BuyerDetail < ApplicationRecord
    ...
    def full_organisation_address
      [organisation_address_line_1, organisation_address_line_2, organisation_address_town, organisation_address_county, organisation_address_postcode]&.compact&.join(', ')
    end
