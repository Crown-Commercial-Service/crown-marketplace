...
module FacilitiesManagement
  class Building < ApplicationRecord
    ...
    BUILDING_TYPES          = [{ id: 'General-office---Customer-Facing', title: 'General office - customer facing', caption: 'General office areas and customer facing areas.' },
                               ...
                               { id: 'Universities-and-Colleges', title: 'Universities and colleges', caption: 'University and college, including on and off site campus facilities but excluding student residential accommodation.' },
