module CCS
  module FM
    class Service < ApplicationRecord
      ...
      # def self.call_off_services
      #   %w(C.9 D.1 F.1 G.9 H.9 H.7 J.7)
      # end

      def self.direct_award_services
        %w[C.11 C.12 C.13 C.1 C.2 C.3 C.4 C.5 C.6 C.7 E.1 E.2 E.3 E.4 E.5 E.6 E.7 E.8 G.15 G.1 G.2 G.3 G.4 G.5 G.6 G.7 H.4 H.5 I.1 I.2 I.3 I.4 J.1 J.2 J.3 J.4 J.5 J.6 K.1 K.2 K.3 K.7 M.1 N.1]
      end
    end
  end
end
