class User < ApplicationRecord
  ...
  has_many :change_logs, inverse_of: :user, dependent: :destroy
  ...
  def fm_buyer_details_incomplete?(framework)
    ...
    if has_role? :buyer
      !(buyer_detail.present? && buyer_detail.details_complete?(framework))
    else
      false
    end
  end
