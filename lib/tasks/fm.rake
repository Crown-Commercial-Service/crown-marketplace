...
INSERT INTO public.fm_units_of_measurement (id, title_text, example_text, unit_text, data_type, service_usage) VALUES(7, 'How many hours are required each year?', 'Example, 520. If this service is required for 10 hours per week, then enter 520 hours per year', '', 'numeric', '{H.4,H.5,I.1,I.2,I.3,I.4,J.1,J.2,J.3,J.4,J.5,J.6}');
