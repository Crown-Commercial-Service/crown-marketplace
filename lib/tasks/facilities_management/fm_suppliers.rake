module CCS
  ...
  def self.supplier_data
    ...
    if is_dev_db.nil? || (is_dev_db.include? 'dev.') || (is_dev_db.include? 'cmpdefault.db.internal.fm-preview') || (is_dev_db.include? 'preview')
