namespace :fm_supplier do
  ...
  task convert_name_to_ids: :environment do
    ...
    FacilitiesManagement::RM3830::SupplierKeyConverterWorker.perform_async(:supplier_name_to_id)
  end
  ...
  task convert_ids_to_names: :environment do
    ...
    FacilitiesManagement::RM3830::SupplierKeyConverterWorker.perform_async(:id_to_supplier_name)
  end
end
