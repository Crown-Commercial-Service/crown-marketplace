module FM
  ...
  def self.create_uom_table
    ActiveRecord::Base.connection_pool.with_connection do |db|
      query = "DROP TABLE IF EXISTS public.facilities_management_rm3830_units_of_measurement; CREATE TABLE public.facilities_management_rm3830_units_of_measurement (
	id serial NOT NULL,
