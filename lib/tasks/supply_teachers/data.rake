namespace :st do
  ...
  file './lib/tasks/supply_teachers/output/supplier_branches.json' => Dir['./lib/tasks/supply_teachers/input/**.xlsx'] do |t|
    ruby "./lib/tasks/supply_teachers/scripts/generate_branches.rb > #{t.name}.tmp 2>> ./lib/tasks/supply_teachers/output/errors.out"
  ...
  file './lib/tasks/supply_teachers/output/supplier_pricing.json' => Dir['./lib/tasks/supply_teachers/input/**.xlsx'] do |t|
    ruby "./lib/tasks/supply_teachers/scripts/generate_pricing.rb > #{t.name}.tmp 2>> ./lib/tasks/supply_teachers/output/errors.out"
    mv "#{t.name}.tmp", t.name
  end

  file './lib/tasks/supply_teachers/output/supplier_vendor_pricing.json' => Dir['./lib/tasks/supply_teachers/input/**.xlsx'] do |t|
    ruby "./lib/tasks/supply_teachers/scripts/generate_vendor_pricing.rb > #{t.name}.tmp 2>> ./lib/tasks/supply_teachers/output/errors.out"
    mv "#{t.name}.tmp", t.name
  end

  file './lib/tasks/supply_teachers/output/supplier_accreditation.json' => Dir['./lib/tasks/supply_teachers/input/**.xlsx'] do |t|
    ruby "./lib/tasks/supply_teachers/scripts/generate_accreditation.rb > #{t.name}.tmp 2>> ./lib/tasks/supply_teachers/output/errors.out"
    mv "#{t.name}.tmp", t.name
  end
