...
def generate_branches
  geographical_data_path = Rails.env.development? ? SupplyTeachers::Admin::Upload::GEOGRAPHICAL_DATA_PATH : s3_path(SupplyTeachers::Admin::Upload::GEOGRAPHICAL_DATA_PATH.to_s)
