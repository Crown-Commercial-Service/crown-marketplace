class AddProcurementRefToProcurementBuildingServices < ActiveRecord::Migration[5.2]
  def change
    ...
    add_index :facilities_management_procurement_building_services, %i[facilities_management_rm3830_procurement_id facilities_management_procurement_building_id], name: 'idx_fm_pbs_fm_p_fm_pb'
  end
end
