class AddUniqueIndex < ActiveRecord::Migration[6.0]
  def change
    ...
    add_index :facilities_management_procurement_pension_funds, %i[name facilities_management_rm3830_procurement_id], unique: true, name: 'index_pension_funds_name_and_procurement_id'
