...
> **_NOTE:_** The project currently runs on 2.7.6 (April 2022) 
...
We use [GitHub Release][] to manage our deployments to the preview and production.
...
- Once you have published the release, the [release action][] will run which will automatically update the `preview` and `production` branches
