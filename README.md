...
##### N.B. The project currently runs on 2.7.3. (May 2021) 

Ensure that a ruby version manager (e.g. rvm or rbenv) is installed and set up properly, using 2.7.3 as the Ruby version before trying anything else. 
