...
- Question-related step classes define attributes matching the parameters supplied by the HTML form and [ActiveModel::Validations][] to define validation rules to constrain the values of those inputs.
